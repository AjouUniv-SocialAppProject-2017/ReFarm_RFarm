...
public class FreeUploadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_freeupload, container, false);
        ...
        myRef.child("freepost").child(stUid).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void uploadImage(){
        ...
        StorageReference mountainsRef = mStorageRef.child("freepost").child(stUid+".jpg");
